# Generated by Django 3.2.7 on 2021-09-29 13:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BearerToken',
            fields=[
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='bearer', serialize=False, to='users.audibledevice')),
        ...
        migrations.CreateModel(
            name='CustomerInfo',
            fields=[
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='customer_info', serialize=False, to='users.audibledevice')),
        ...
        migrations.CreateModel(
            name='DeviceInfo',
            fields=[
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='device_info', serialize=False, to='users.audibledevice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='mac_dms', serialize=False, to='users.audibledevice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('device', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='store_cookie', serialize=False, to='users.audibledevice')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='website_cookies', to='users.audibledevice')),
            ],
        ),
    ]
